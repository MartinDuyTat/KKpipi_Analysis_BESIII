...
void cisiK0pipiRooFit::Initialise(const Settings &settings) {
  // First initialise Ki
...
void cisiK0pipiRooFit::InitialiseKi(const Settings &settings, const std::string &TagMode) {
  for(int i = 1; i <= 8; i++) {
...
void cisiK0pipiRooFit::Initialisecisi(const Settings &settings) {
...
TMatrixT<double> cisiK0pipiRooFit::ParseCorrelationMatrix(const Settings &settings) const {
