...
void cisiFitter::SetupMinimiserWithGamma(ROOT::Minuit2::Minuit2Minimizer &Minimiser) const {
  ...
  Minimiser.SetVariable(6*m_NumberBins + 7, "BMinusDKYield", 1500.0, 1000.0);
  Minimiser.SetVariableLimits(6*m_NumberBins + 7, 100.0, 5000.0);
  Minimiser.SetVariable(6*m_NumberBins + 8, "BPlusDKYield", 1500.0, 1000.0);
  Minimiser.SetVariableLimits(6*m_NumberBins + 8, 100.0, 5000.0);
  Minimiser.SetVariable(6*m_NumberBins + 9, "BMinusDpiYield", 20000.0, 10000.0);
  Minimiser.SetVariableLimits(6*m_NumberBins + 9, 1000.0, 70000.0);
  Minimiser.SetVariable(6*m_NumberBins + 10, "BPlusDpiYield", 20000.0, 10000.0);
  Minimiser.SetVariableLimits(6*m_NumberBins + 10, 1000.0, 70000.0);
...
void cisiFitter::ScanGammaDeltaB(ROOT::Minuit2::Minuit2Minimizer &Minimiser) const {
  TCanvas c("c", "", 1200, 900);
  std::vector<double> x, y, z;
  Minimiser.SetPrintLevel(-1);
  for(double gamma = 40.0; gamma <= 160.0; gamma += 10.0) {
    for(double deltaB_dk = 40.0; deltaB_dk <= 160.0; deltaB_dk += 10.0) {
